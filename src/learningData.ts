...
export const TOPICS_ML: TopicGroup[] = [
    ...
    },
    {
        ...
        topics: [
            ...
            { id: "2.9", title: "Practice Questions" },
        ],
    },
    {
        title: "3. Supervised Learning - Optimization",
        topics: [
            { id: "3.1", title: "Gradient Descent Overview" },
            { id: "3.2", title: "Implementing Gradient Descent" },
            { id: "3.3", title: "The Derivative Intuition" },
            { id: "3.4", title: "The Learning Rate (alpha)" },
            { id: "3.5", title: "Linear Regression with Gradient Descent" },
            { id: "3.6", title: "Optional Lab: Gradient Descent" },
            { id: "3.7", title: "Revision: Gradient Descent" },
            { id: "3.8", title: "Practice Questions" },
        ],
    },
    {
...
export const TOPICS_ENGLISH: TopicGroup[] = [
    {
        title: "1. Tenses",
        topics: [
            { id: "1.1", title: "The Simple Truth (Present Simple)" },
            { id: "1.2", title: "Wait, What is Present Continuous?" },
        ],
    },
];
